...
class Ak47:
	...
	fov_scale = 1.33
        ...
        self.wiimote.enable(cwiid.RPT_MOTIONPLUS)
        self.wiimote.led = cwiid.LED1_ON
        self.wiimote.rpt_mode = 148 #cwiid.RPT_IR | cwiid.RPT_BTN | cwiid.RPT_MOTIONPLUS
        print self.wiimote.state
    ...
    def callback(self, mesg_list, time):
		...
		if mesg[1]==0:
                ...
                print "Wiimote: Unknown Report:", mesg
